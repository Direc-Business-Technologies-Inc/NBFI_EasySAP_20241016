...
{
    public interface IARInvoiceModel
    {
        ...
        DataTable SelectPickListDocument(string CardCode, string OrderEntry, string AbsEntry);
        DataTable SelectDocumentLines(string table, string docEntry);
        DataTable SelectPickListDocumentLines(string table, string docEntry);
