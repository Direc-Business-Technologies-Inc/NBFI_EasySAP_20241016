...
namespace PresenterLayer
{
    public interface IPurchaseOrderModel
    {
        ...
        DataTable GetUDF();
        bool ActivateService(Func<string, string> p, string request, string docEntry, StringBuilder json, StringBuilder jsonH, bool isUserGoApproval, bool isApproved = false, string bstat = "Open");
        ...
        DataTable SelectDocumentLines(string table, string docEntry);
        ...
        List<string> GetGL(string TransType);
        string GetEmpID();
    }
}
