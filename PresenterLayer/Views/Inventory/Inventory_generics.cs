...
{
    public class Inventory_generics
    {
        ...
        public List<string> ModalShow(string searchKey, List<string> Parameters, string title)
        {
            ...
            {
                frmSearch2.Param1 = string.Empty;
                frmSearch2.Param2 = string.Empty;
                frmSearch2.Param3 = string.Empty;
                frmSearch2.Param4 = string.Empty;
                frmSearch2.Param5 = string.Empty;
            }
        ...
        {
            //DataTable dt = DataAccess.Select(DataAccess.conStr("HANA"), query);
        ...
        public bool IsDraft ()
        {
            ...
            string query =  $"SELECT Distinct T2.U_NAME FROM OWTM T0 INNER JOIN WTM3 T1 ON T1.WtmCode = T0.WtmCode " +
                            ...
                            $"INNER JOIN OUSR T2 ON T2.userSign = T0.UserSign WHERE T0.Active = 'Y' AND T1.TransType = 22 AND T2.U_NAME = '{sboCredentials.UserId}'";
