...
{
    public interface IFrmUnofficialSales
    {
        ...
        UnofficialSalesService Presenter { set; }
        ...
        string WhsSlsType { get; set; }
        ComboBox WhsSls { get;}

        string CustomRef { get; set; }

        string Address { get; set; }
        string BPCode { get; set; }

        string sOProject { get; set; }
    }
}
